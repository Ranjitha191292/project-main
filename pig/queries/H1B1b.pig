data1 = LOAD '/home/hduser/test' USING PigStorage('\t') as (s_no:double,case_status:chararray,employer_name:chararray,soc_name:chararray,job_title:chararray,full_time_position:chararray,prevailing_wage:double,year:chararray,worksite:chararray,longitude,latitude);
...
--STORE data25 INTO 'home/hduser/H11b' USING PigStorage('\t');
dump data25;
